...
{
    public partial class BeatReactiveContainer : Container
    {
        ...
        /// 1.0 = no change, 1.2 = 20% larger, etc.
        /// </summary>
        public float MaxScalePercentage { get; set; } = 1.15f;
        ...
        protected override void Update()
        {
            ...
            const float bounce_threshold = 1.85f;
            const float decay_speed = 170;
